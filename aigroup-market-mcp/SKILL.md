...
Use this skill when the question is China-market specific and the `aigroup-market-mcp` server is available.
...
- Prefer this skill over generic market tools when the data question is China-specific.
- Use the smallest relevant dataset; do not pull every flow endpoint unless the user wants a full market brief.
- Clarify time granularity up front for minute data versus daily data.
- If a query sounds global but the user references A-shares, CSI indices, or Tushare-style fields, route here first.
